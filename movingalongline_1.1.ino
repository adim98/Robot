...
void motor_turnleft() {
  motor1.setSpeed(25);   // Motor 1 runs forward at full speed.
  motor2.setSpeed(-25);  // Motor 2 runs backward at full speed.
  Serial.println("left");
  delay(1000);
}

void motor_turnright() {
  motor1.setSpeed(-25);  // Motor 1 runs backward at full speed.
  motor2.setSpeed(25);   // Motor 2 runs forward at full speed.
